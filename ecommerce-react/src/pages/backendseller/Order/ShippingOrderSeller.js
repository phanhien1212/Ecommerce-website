  ...
  useEffect(() => {
    (async () => {
      ...
      const filteredOrders = responseData.filter(
        (order) =>
          order.seller_id === parseInt(sellerId) && order.order_status === 2
      );
        ...
        <div className="d-flex flex-row mx-auto">
          ...
          <div className="p-2 me-3 my-auto">
            <Link
              ...
              to={"/seller/orderseller/shipping/" + sellerId}
            >
              Đang giao
            </Link>
          </div>
...
export default ShippingOrderSeller;
