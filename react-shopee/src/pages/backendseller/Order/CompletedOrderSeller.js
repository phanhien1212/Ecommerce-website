  ...
  useEffect(() => {
    (async () => {
      ...
      const filteredOrders = responseData.filter(
        (order) =>
          order.seller_id === parseInt(sellerId) && order.order_status === 3
      );
    ...
    <div className="d-flex p-2 row " style={{ height: 70 }}>
      <div className="col-md-12 border-bottom">
        <div className="d-flex flex-row mx-auto">
          ...
          <div className=" p-2 me-3 my-auto ">
            <Link to={"/seller/orderseller/waitting/" + sellerId}>
              Chờ xác nhận{" "}
            </Link>
          </div>
          <div className="p-2 me-3 my-auto">
          ...
          <div className="p-2 me-3 my-auto">
            <Link
              ...
              to={"/seller/orderseller/completed/" + sellerId}
            >
              Đã giao
            </Link>
          </div>
...
export default CompletedOrderSelle;
