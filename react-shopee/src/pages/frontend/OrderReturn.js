...
const OrderReturn = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const filteredOrders = responseData.filter(
        (order) =>
          order.user_id === parseInt(buyerId) && order.order_detail_status === 5
      );
  ...
  const handleComplete = async (order_id) => {
    ...
    await OrderService.updatestatusorderdetail(order_id, updateStatus);
  };
                                ...
                                case 5:
                                  return (
                                    <button
                                      style={{ marginLeft: 780 }}
                                      onClick={() =>
                                        handleDetail(order.order_detail_id)
                                      }
                                      className="stardust-button stardust-button--primary QY7kZh"
                                    >
