    ...
    <div>
      ...
      >
        <div id="shopee-mini-chat-embedded">
          <div className="UvGSSkd1qQ" style={{ borderRadius: 4 ,width:1200}}>
                ...
                <div className="t0DSoDjLOv">
                  <i className="GHUxSkxNuJ GQqiEMsjau">
                    <svg
                      ...
                      className="chat-icon"
                    >
                      <path d="M2.788 12L3 11.383c-.514-.443-.959-1.113-1.335-2.013-.376-.9-.564-2.01-.564-3.333v-.074c0-1.323.189-2.434.567-3.333.378-.9.822-1.553 1.332-1.961L2.788.006 2.754 0C2.102.354 1.48 1.063.888 2.127.296 3.19 0 4.473 0 5.974v.052c0 1.505.296 2.789.888 3.85.592 1.062 1.214 1.77 1.866 2.124h.034z" />
                    </svg>
                  </i>
                  1
                  <i className="GHUxSkxNuJ sCTuxhWsM6">
                    <svg
                      ...
                      className="chat-icon"
                    >
                      <path d="M.246 12c.648-.354 1.269-1.062 1.863-2.124C2.703 8.815 3 7.531 3 6.026v-.052c0-1.501-.297-2.784-.891-3.847C1.515 1.063.894.354.246 0H.212L0 .617c.48.42.917 1.09 1.31 2.01.393.92.59 2.032.59 3.336v.074c0 1.33-.191 2.454-.573 3.37-.382.917-.824 1.575-1.327 1.976L.212 12h.034z" />
                    </svg>
                  </i>
                </div>
              </div>
                  ...
                  <div>
                    <i className="GHUxSkxNuJ dktYUG_IaQ X8XVK1EpGd">
                      <svg
                        ...
                        className="chat-icon"
                      >
                        <path d="M14 1a1 1 0 011 1v12a1 1 0 01-1 1H8v-1h6V2H2v5H1V2a1 1 0 011-1h12zM5.5 9a.5.5 0 01.5.5v4a.5.5 0 01-1 0v-2.744l-3.34 3.34a.5.5 0 01-.637.058l-.07-.058a.5.5 0 01-.057-.638l.058-.069L4.342 10H1.5a.5.5 0 010-1h4z" />
                      </svg>
                    </i>
                  </div>
                </div>
            ...
            <div className="Z8RjJZsXy1">
              ...
              >
                <div className="uM6AUh43Zu" />
              </div>
              <div className="PHu35ijDVb" style={{width:420}}>
                      ...
                      >
                            ...
                            >
                              ...
                              >
                                <img
                                  ...
                                  src="http://localhost:8080/images//user/019ed89d540c28d61fbd0e29761ebd4a_tn.webp"
                                />
                                <div className="Dcv8CzncwR" style={{width:420}}>
                                  <div className="wU7cFyNgJE">
                                    <div className="oMCwya4MZe">
                                      <a
                                        href="/product-detail/ao-baby-tee-twenti-om-body-in-kim-tuyen"
                                        previewlistener="true"
                                        
                                      >
                                        <div
                                          className="HzTC4LV8Q6"
                                          title="thegioiskinfood"
                                        >
                                          thegioiskinfood
                                        </div>
                                      </a>
                        ...
                        <div className="resize-triggers">
                          <div className="expand-trigger">
                            <div style={{ width: 225, height: 413 }} />
                          </div>
              ...
              <div className="C8Jzw7jkTU" style={{width:690}}>
                <div className="gLbzKNEAYF">
                  <div className="DOFDK5HL9H">
                    <div className="shopee-react-dropdown">
                      <div className="Bovr3kIM9j">
                        <div className="lyWL3rDmij"> Twenti</div>
                  ...
                  <div id="messagesContainer" className="WHIaShCfot">
                    <div className="uSCzLeGnGd null">
                      <div className="MjLuVfkgAr null">
                        ...
                        >
                          <div
                            style={{ overflow: "visible", height: 0 }}
                          >
                            <div
                              aria-label="grid"
                              aria-readonly="true"
                          ...
                          <div className="X6NljyWyEg">
                            <div className="RR2wewQMSf">
                              ...
                              <div className="C4eQ_E6clG">
                                <button
                                  className="pqq6o4R57Y "
                                  style={{
                                    border: "none",
                                    backgroundColor: "rgb(255, 255, 255)",
                                  }}
                                >
                                  <i className="GHUxSkxNuJ efElYaAvMZ plW8rzAMob">
                                    <svg
                                      viewBox="0 0 24 24"
                                      xmlns="http://www.w3.org/2000/svg"
                                      className="chat-icon colorshopee"
                                    >
                                      <path d="M4 14.497v3.724L18.409 12 4 5.779v3.718l10 2.5-10 2.5zM2.698 3.038l18.63 8.044a1 1 0 010 1.836l-18.63 8.044a.5.5 0 01-.698-.46V3.498a.5.5 0 01.698-.459z" />
                                    </svg>
                                  </i>
                                </button>
                              </div>
