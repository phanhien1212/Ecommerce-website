                ...
                <div className="row sm-gutter app__content">
                    ...
                    <div className="col l-10 m-12 c-12">
                        <section className="QmO3Bu" aria-role="tablist">
                            ...
                            <a className="KI5har" title="Tất cả" aria-role="tab" aria-selected="true" href="/order">
                                <span className="NoH9rC">
                                    Tất cả
                                </span>
                            </a>
                            <a className="KI5har " title="Chờ thanh toán" aria-role="tab" aria-selected="false" href="/user/purchase/?type=9">
                                <span className="NoH9rC">
                                    Chờ thanh toán
                                </span>
                            </a>
                            <a className="KI5har" title="Vận chuyển" aria-role="tab" aria-selected="false" href="/user/purchase/?type=7">
                                <span className="NoH9rC">
                                    Vận chuyển
                                </span>
                            </a>
                            <a className="KI5har mRVNLm" title="Chờ giao hàng" aria-role="tab" aria-selected="false" href="/waiting-delivery">
                                <span className="NoH9rC">
                                    Chờ giao hàng
                                </span>
                            </a>
                            <a className="KI5har" title="Hoàn thành" aria-role="tab" aria-selected="false" href="/success-delivery">
                                <span className="NoH9rC">
                                    Hoàn thành
                                </span>
                            </a>
                            <a className="KI5har" title="Đã hủy" aria-role="tab" aria-selected="false" aria-controls="olp_panel_id-0.016262427448072936" id="olp_tab_id-0.016262427448072936" href="/user/purchase/?type=4">
                                <span className="NoH9rC">
                                    Đã hủy
                                </span>
                            </a>
                            <a className="KI5har" title="Trả hàng/Hoàn tiền" aria-role="tab" aria-selected="false" aria-controls="olp_panel_id-0.8145434458437977" id="olp_tab_id-0.8145434458437977" href="/user/purchase/?type=12">
                                <span className="NoH9rC">
                                    Trả hàng/Hoàn tiền
                                </span>
                            </a>
                        ...
                        <div className="home-product">
                            ...
                            <main aria-role="tabpanel" aria-labelledby="olp_tab_id-0.44408754544375273" id="olp_panel_id-0.44408754544375273">
                                <h2 className="a11y-hidden">
                                </h2>
                                <div>
                                    <div className="YL_VlX">
                                        <div>
                                            <div className="J632se">
                                                    ...
                                                    <div className="P2JMvg">
                                                        <div className="RBPP9y">
                                                            <div className="Koi0Pw">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width={62} height={16} fill="none">
                                                                    ...
                                                                    <path fill="#EE4D2D" fillRule="evenodd" d="M0 2C0 .9.9 0 2 0h58a2 2 0 012 2v12a2 2 0 01-2 2H2a2 2 0 01-2-2V2z" clipRule="evenodd">
                                                                    </path>
                                                            ...
                                                            <a className="Mr26O7" href="/phulieutoc_ngocbich?entryPoint=OrderDetail">
                                                        ...
                                                        <div className="jgIyoX">
                                                            <div className="LY5oll">
                                                                <a className="lXbYsi" href="/user/purchase/order/162834213270520?type=6">
                                                                ...
                                                                <div className="shopee-drawer" id="pc-drawer-id-42" tabIndex={0}>
                                                ...
                                                <section>
                                                    ...
                                                    <a aria-label href="/user/purchase/order/162834213270520?type=6">
                                                        <div>
                                                                        ...
                                                                        <section>
                                                                            <div className="mZ1OWk">
                                                                                <div className="dJaa92">
                                                                                    <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lpbtuk21fxi303_tn" className="gQuHsZ" alt tabIndex={0} />
                                                                                    <div className="nmdHRf">
                                                                                        <div>
                                                                                            <div className="zWrp4w">
                                                                                                <span className="DWVWOJ" tabIndex={0}>
                                                                                                    Tẩy tóc , nâng tone , không xót da dà đầu - 150ml
                                                                                                </span>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div>
                                                                                            <div className="rsautk" tabIndex={0}>
                                                                                                Phân loại hàng: Tẩy Yếu
                                                                                            </div>
                                                ...
                                                <div className="Ze0Icc">
                                                </div>
                                            </div>
                                        </div>
                                        <div className="peteXU">
                                            <div className="IVFywZ HmaSt0">
                                            </div>
                                            <div className="IVFywZ fT_AQM">
                                            </div>
                                        </div>
                                        ...
                                        <div className="yyqgYp">
                                            <div className="iwUeSD">
                                                <div>
                                                    <span className="CDsaN0" aria-label="Đánh giá sản phẩm trước 01-04-2024" tabIndex={0}>
                                                        Đánh giá sản phẩm trước
                                                        <div className="shopee-drawer" id="pc-drawer-id-43" tabIndex={0}>
                                                            <u className="GQOPby" aria-describedby="0.06838241984577786">
                                                                01-04-2024
                                                            </u>
                                                        </div>
                                                    </span>
                                                </div>
                                                <span className="f423Cb">
                                            ...
                                            <section className="po9nwN">
                                                ...
                                                <div className="aAXjeK">
                                                    <div>
                                                        <button className="stardust-button stardust-button--primary QY7kZh yaOLa5">
                                                            Đã nhận hàng
                                                        </button>
                                                    </div>
                                                </div>
                                                <div className="hbQXWm">
                                                    <div>
                                                        ...
                                                        <button className="stardust-button stardust-button--secondary QY7kZh yaOLa5">
                                ...
                                <div>
                                    <div className="spinner-container">
                                        <div className="stardust-spinner">
                                            <div className="stardust-spinner__background stardust-spinner__background--no-overlay">
